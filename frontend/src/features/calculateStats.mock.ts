...
export const legsData: Leg[] = [
	{
		...
		legGeometry: {
			...
			length: 37,
			points:
				"qkdnJkgawCEAQiAb@i@dBoAB???RMB?NMHIDClAMX?@W?S@[AO?g@AYCaBEkB?a@?CASzAgBlA{AXZDDBI@KDO@M@GBODD^b@",
		},
		from: {
			__typename: "Place",
			stop: null,
	...
	},
	{
		...
		legGeometry: {
			...
			length: 113,
			points:
				"k{cnJkbbwCY[eAiAmAqAo@s@gBmBgBqBMOKGICICOB{@H{APsD^yCZk@FqAVUB??[@MCKOMc@Sk@IMGKOCQ?cEd@S?MGGGIQKYm@aCOk@Ok@KYKEGCK@KJKNKPQZ??g@p@OPMD[Fu@NO@O?MGIIOY{@mDcA}DyA{Fu@eCa@kB??Mk@q@mCk@cCoAcFAQAQAa@Cu@EQEQCMGGQM_Aa@{@_@{@a@oAc@??[OIKGMGOaAcEi@wBUaAEQ?Q?WBYN[l@cAFQ@W?YCQG_@k@kB??YiA[iAu@mCkB}Gi@qBMg@Mg@CQI]CSAo@EoF",
		},
		from: {
			__typename: "Place",
			stop: {
	...
	},
	{
		...
		legGeometry: {
			...
			length: 62,
			points:
				"abgnJkvfwCx@iCJc@Cm@CYKq@[wAW}@iAkFe@iBQ_@QYYO_@Q]Yu@{@mAwAk@o@uAoBm@u@US_@k@Qg@IQIQ[UMCED_@Ko@DeADS@??[BmCHqDRYFGkHI]OKcERa@@E@CaB]BcBD}AF??YC[@y@DMBGH{@zAGR{@eDgFeSc@eB[cAi@sAWk@o@{A",
		},
		from: {
			__typename: "Place",
			stop: {
	...
	},
	{
		...
		legGeometry: {
			...
			length: 82,
			points:
				"olinJioiwCd@hADJZx@@@BC@A@?Rd@DJKTIPCDGNITBJGVCHGRCHABABCJCHAFOd@IXIXQl@ADITENGVM^AFCJCB?BCDAFADCDAF?@CFENK\\A@EPOUEIACCEEGMU]m@GIe@w@[k@k@eAAe@QSQQ?DE?k@o@q@u@EPEROn@Qr@CLGNCJKd@KZ?@A?s@DE?c@s@GZ",
		},
		from: {
			__typename: "Place",
			stop: {
